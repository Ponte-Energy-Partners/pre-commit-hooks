...
def test_success():
    result = runner.invoke(verify_git_email.app, ["--domain", "icloud.com"])
...
def test_not_correctly_configured_email():
    result = runner.invoke(verify_git_email.app, ["--domain", "gmail.com"])
...
def test_missing_domain():
    ...
    assert result.exception.args == ("`domain` is required",)
